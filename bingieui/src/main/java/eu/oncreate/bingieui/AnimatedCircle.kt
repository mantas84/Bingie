...
//From https://github.com/android/compose-samples/blob/master/Rally/app/src/main/java/com/example/compose/rally/ui/components/RallyAnimatedCircle.kt
...
fun AnimatedCircle(
    proportions: List<Float> = listOf(0.75f, 0.25f),
    colors: List<Color> = listOf(Color.Red, Color.DarkGray),
    modifier: Modifier = Modifier.background(Color.White).preferredSize(320.dp)
) {
    ...
    Canvas(modifier) {
        ...
        var startAngle = state[Shift] - 270f
